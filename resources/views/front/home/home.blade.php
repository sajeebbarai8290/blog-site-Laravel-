...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100">
                <img src="{{asset($popularBlog->blogImage)}}" alt="{{$popularBlog->blogTitle}}" class="card-img-top" height="250"/>
                <div class="card-body">
                    <h4 class="card-title">{{$popularBlog->blogTitle}}</h4>
                    <p class="card-text">{{$popularBlog->blogShortDescription}}</p>
                </div>
                <div class="card-footer">
